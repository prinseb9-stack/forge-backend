...
func (c *Connector) ID() string                    { return "substack" }
func (c *Connector) Name() string                  { return "Substack" }
func (c *Connector) Icon() string                  { return "📰" }
func (c *Connector) Description() string           { return "Newsletter and article publishing." }
